...
public final class BluechipAdminCommand implements CommandExecutor, TabCompleter {
    ...
    private void usage(CommandSender sender){sender.sendMessage(messages.result("用法：/stockadmin bluechip <init|pause|resume|fund <代码> shares <值>|event <代码|market> <影响万分比>|event industry <行业> <影响万分比>>；现金由托管资金自动管理。"));}
