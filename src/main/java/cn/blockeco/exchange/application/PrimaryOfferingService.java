...
public class PrimaryOfferingService {
 ...
 public CompletionStage<IpoSubscriptionRecoverySummary> recoverSubscriptionsAtStartup(){return CompletableFuture.supplyAsync(()->transactions.inTransaction(c->offerings.recoverSubscriptionsAtStartup(c,clock.now())),executor);}
 public CompletionStage<List<IpoSubscriptionRecoveryRecord>> ambiguousSubscriptions(){return CompletableFuture.supplyAsync(offerings::findAmbiguousSubscriptions,executor);}
